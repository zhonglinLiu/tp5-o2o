<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\study\o2o\public/../application/admin\view\citys\add.html";i:1490098170;s:64:"F:\study\o2o\public/../application/admin\view\public\header.html";i:1490000720;s:64:"F:\study\o2o\public/../application/admin\view\public\footer.html";i:1490865711;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<form class="form form-horizontal form-o2o-add" id="form-o2o-add" method="post" action="<?php echo url('citys/save'); ?>">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="选填" id="name" name="uname">
			</div>
		</div>
		<div class="row cl">
