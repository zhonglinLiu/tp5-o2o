<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"F:\study\o2o\public/../application/admin\view\store\dellist.html";i:1490444732;s:64:"F:\study\o2o\public/../application/admin\view\public\header.html";i:1490000720;s:64:"F:\study\o2o\public/../application/admin\view\public\footer.html";i:1490006929;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tr class="text-c">
				...
				<td class="td-status"><a href="<?php echo url('stores/status',['status'=>$v['status']==1?0:1,'id'=>$v['id']]); ?>" title="点击修改状态"><?php echo status($v['status']); ?></a></td>

				<td class="td-manage">
					<a style="text-decoration:none" class="ml-5" onClick="o2o_s_edit('门店详情','<?php echo url('stores/detail',['id'=>$v['id']]); ?>','',300)" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
				</td>
			</tr>
