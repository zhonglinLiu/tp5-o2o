	...
	基本信息：
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $deal['name']; ?>" placeholder="" id="" name="name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-2"> 
				...
				<select name="city_id" class="select cityId">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($deal['city_id'][0] == $vo['id']): ?>selected<?php endif; ?> ><?php echo $vo['name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				</span>
			</div>
			<div class="formControls col-xs-8 col-sm-2">
					<?php if(is_array($deal['name']) || $deal['name'] instanceof \think\Collection || $deal['name'] instanceof \think\Paginator): $i = 0; $__LIST__ = $deal['name'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
				<select name="category_id" class="select categoryId">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($deal['category_id'] == $vo['id']): ?>selected<?php endif; ?> ><?php echo $vo['name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				</span>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<input name="location_ids[]" type="checkbox" id="checkbox" value="<?php echo $v['id']; ?>"/><?php echo $v['name']; endforeach; endif; else: echo "" ;endif; ?>
				</div>
			</div>
		</div>
		...
		<div class="row cl">
              ...
              <div class="formControls col-xs-8 col-sm-9">
                <img id="upload_org_code_img" src="<?php echo $deal['image']; ?>" width="150" height="150">
              </div>
        </div>
        <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $deal['total_count']; ?>" placeholder="" id="" name="total_count">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">原价:</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $deal['origin_price']; ?>" placeholder="" id="" name="origin_price">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">团购价:</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $deal['current_price']; ?>" placeholder="" id="" name="current_price">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<script id="editor"  type="text/plain" name="description" style="width:80%;height:300px;"><?php echo $deal['description']; ?></script>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">购买须知：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<script id="editor2"  type="text/plain" name="notes" style="width:80%;height:300px;"><?php echo $deal['notes']; ?></script>
			</div>
		</div>
