<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"F:\study\o2o\public/../application/admin\view\category\edit.html";i:1490003919;s:64:"F:\study\o2o\public/../application/admin\view\public\header.html";i:1490000720;s:64:"F:\study\o2o\public/../application/admin\view\public\footer.html";i:1490006929;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="parent_id" class="select">
					...
					<option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $cate['parent_id']): ?>selected <?php endif; ?> ><?php echo $v['name']; ?></option>
