<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"F:\study\o2o\public/../application/index\view\order\confirm.html";i:1491040181;s:64:"F:\study\o2o\public/../application/index\view\public\header.html";i:1490779098;s:61:"F:\study\o2o\public/../application/index\view\public\top.html";i:1490767783;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="firstly">
    <div class="bindmobile-wrap">
        采用<span style="color:red">微信支付</span>，购买成功后，团购券将发到您的注册邮箱：<span class="mobile"><?php echo $email; ?></span><a class="link"></a>
    </div>
...
<!--支付第二步-->
<form action="<?php echo url('pay/index'); ?>" method="post" >
<div class="secondly">
    <div class="search">
                    ...
                    <td class="fl_left ">
                        <ul class="order-list">
                            <li>
                                ...
                                <span class="order-list-name"><?php echo $deal['name']; ?></span><span class="order-list-number"><?php echo $count; ?>份</span>
                            </li>
                        </ul>
                    </td>
                    <td class="fl_right">
    ...
    <input type="hidden" name="name" value="<?php echo $deal['name']; ?>">
