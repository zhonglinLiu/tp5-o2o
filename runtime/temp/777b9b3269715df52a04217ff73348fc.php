<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\study\o2o\public/../application/index\view\user\register.html";i:1490528521;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="content">
            <form method="post" action="<?php echo url('user/register'); ?>">
                ...
                <p class="pass-form-item">
                    ...
                    <input type="password" name="repass" class="pass-text-input" placeholder="请设置登录密码">
                </p>
                <p class="pass-form-item">
