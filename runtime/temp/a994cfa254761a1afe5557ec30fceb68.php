...
<div class="page-container">
	<form class="form form-horizontal form-o2o-add" id="liu-form" method="post" action="<?php echo url('citys/save'); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>管理员名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text check_null" attr-msg='用户名不能为空' value="" placeholder="必填" id="name" name="username">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>邮箱：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text check_null" attr-msg='邮箱不能为空' value="" placeholder="必填" id="name" name="email">
			</div>
		</div>
		<div class="row cl">
...
var SCOPE = {
	save_url:'<?php echo url("admin/add"); ?>',
	jump_url:'',
}
</script>
