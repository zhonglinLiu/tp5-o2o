<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\study\o2o\public/../application/admin\view\category\index.html";i:1492017278;s:64:"F:\study\o2o\public/../application/admin\view\public\header.html";i:1490000720;s:64:"F:\study\o2o\public/../application/admin\view\public\footer.html";i:1490865711;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-status"><a href="<?php echo url('category/status',['status'=>$cate['status']==1?0:1,'id'=>$cate['id']]); ?>" title="点击修改状态"><?php echo status($cate['status']); ?></a></td>
					<td class="td-manage">
						<a href="<?php echo url('category/index',['parent_id'=>$cate['id']]); ?>">获取子栏目</a>
						<a style="text-decoration:none" class="ml-5" onClick="o2o_s_edit('编辑','<?php echo url('category/edit',['id'=>$cate['id']]); ?>','',300)" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('category/status',['id'=>$cate['id'],'status'=>-1]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
...
<?php echo renderPagination($cates); ?>
...
<script>
var SCOPE = {
    save_url: '<?php echo url("category/listorder"); ?>',
}
